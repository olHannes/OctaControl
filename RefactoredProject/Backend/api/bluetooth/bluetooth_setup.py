...
# Hilfsfunktion: Führt mehrere bluetoothctl-Befehle (via stdin) aus und gibt stdout, stderr, rc zurück.
...
def power():
    ...
    try:
        ...
        # small sanity-check: ask bluetoothctl show to confirm state
...
def scan_devices():
    ...
    try:
        # optional scan duration param (int seconds)
        try:
...
def bt_status():
    ...
    try:
        ...
        if rc_show < 0:
            ...
            # If bluetoothctl not present or other fatal error, return a helpful error
        ...
        # discoverable timeout parsing (hex or decimal)
